...
export async function onRequest({request}){
 ...
 if(path==='/landingpage/api/reserva')return handleReservation(request,endpoint);
 if(!['GET','HEAD'].includes(request.method))return new Response('Método não permitido',{status:405});
 const routes={'/landingpage':[html,'text/html; charset=utf-8'],'/landingpage/index.html':[html,'text/html; charset=utf-8'],'/landingpage/styles.css':[css,'text/css; charset=utf-8'],'/landingpage/form.js':[js,'text/javascript; charset=utf-8']};
